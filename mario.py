...
cactus_img = pygame.image.load('resources/cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('resources/fire_bricks.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('resources/fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('resources/mario.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('resources/mario_dies.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('resources/end.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('resources/start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('resources/mario_theme.wav')
